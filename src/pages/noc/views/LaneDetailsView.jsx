...
const LaneDetailsView = () => {
  ...
  return (
    <div className="lane-details-page">
      <NOCHeader
        title={lane?.name || 'Lane'}
        subtitle={`${facility?.name || 'Facility'} · ${lane?.type || ''}`}
        backPath={`/noc/${facilityCode}`}
        showTime={true}
      />
      <div className="lane-details-wrapper">
        {/* Title */}
        <div className="ld-title-row">
          <div className="ld-title-left">
            <h1>{lane?.name || 'Lane'}</h1>
            <span className="ld-tag-hybrid">{lane?.type || 'Hybrid'}</span>
          </div>
          <div className="ld-issues-btn">
            <span className="ld-issues-dot"></span>2 Issues Detected
          </div>
        </div>
        ...
        <div className="ld-section">
          ...
          <div className="ld-server-card">
            <div className="ld-server-header">
              ...
              <div className="ld-status-green">
                <span className="ld-status-dot"></span> ONLINE
              </div>
            </div>
            <div className="ld-server-stats">
              ...
              <div className="ld-stat-row">
                <span>CPU Usage</span>
                <strong className="ld-text-green">34%</strong>
              </div>
              <div className="ld-stat-row">
                <span>Memory</span>
                <strong>12.4 / 32 GB (39%)</strong>
              </div>
              <div className="ld-stat-row">
                <span>Disk</span>
                <strong>186 / 500 GB (37%)</strong>
              </div>
              <div className="ld-stat-row">
                <span>Uptime</span>
                <strong className="ld-text-green">14d 7h 32m</strong>
              </div>
              <div className="ld-stat-row">
              ...
              <div className="ld-stat-row">
                <span>Network</span>
                <strong className="ld-text-green">1 Gbps (eth0)</strong>
              </div>
              <div className="ld-stat-row">
                <span>Active Services</span>
                <strong className="ld-text-green">7 / 7 running</strong>
              </div>
              <div className="ld-stat-row">
                <span>Last Restart</span>
                <strong>2026-03-10 02:00</strong>
              </div>
            </div>
          </div>
        </div>
          ...
          <div className="ld-equipment-grid">
            <div className="ld-eq-card">
              <div className="ld-eq-header ld-eq-offline">
                <div className="ld-eq-title">
                  <Zap size={16} /> Bowling Machine
                </div>
                <div className="ld-status-red">
                  <span className="ld-status-dot"></span> OFFLINE
                </div>
              </div>
              <div className="ld-eq-body">
                <div className="ld-eq-row">
                  <span>IP Address</span>
                  <strong>192.168.1.107</strong>
                </div>
                <div className="ld-eq-row">
                  <span>Last Calibrated</span>
                  <strong>2026-03-20 09:15</strong>
                </div>
                <div className="ld-eq-row">
                  <span>Angles</span>
                  <strong>Pitch: 12° / Yaw: 3°</strong>
                </div>
                <div className="ld-eq-row">
                  <span>Model</span>
                  <strong>BM-Pro 3000</strong>
                </div>
                <div className="ld-eq-row">
                  <span>Speed Range</span>
                  <strong>60-150 km/h</strong>
                </div>
                <div className="ld-eq-alert">
                  <AlertTriangle size={14} />
                  <div>
                    Motor overheating —<br />
                    shutdown triggered at 14:28:03
                  </div>
                </div>
              </div>
            </div>
            <div className="ld-eq-card">
              ...
              <div className="ld-eq-body">
                <div className="ld-eq-row">
                  <span>IP Address</span>
                  <strong>192.168.1.121</strong>
                </div>
                <div className="ld-eq-row">
                  <span>Last Calibrated</span>
                  <strong>2026-03-22 11:30</strong>
                </div>
                <div className="ld-eq-row">
                  <span>Angles</span>
                  <strong>Pan: -5° / Tilt: 15°</strong>
                </div>
                <div className="ld-eq-row">
                  <span>Resolution</span>
                  <strong>1920x1080 @ 60fps</strong>
                </div>
                <div className="ld-eq-row">
                  <span>FPS Current</span>
                  <strong className="ld-text-green">58.4</strong>
                </div>
              </div>
            </div>
            <div className="ld-eq-card">
              <div className="ld-eq-header">
                <div className="ld-eq-title">
                  <Camera size={16} /> CV Right Camera
                </div>
                <div className="ld-status-green">
                  <span className="ld-status-dot"></span> ONLINE
                </div>
              ...
              <div className="ld-eq-body">
                <div className="ld-eq-row">
                  <span>IP Address</span>
                  <strong>192.168.1.122</strong>
                </div>
                <div className="ld-eq-row">
                  <span>Last Calibrated</span>
                  <strong>2026-03-22 11:32</strong>
                </div>
                <div className="ld-eq-row">
                  <span>Angles</span>
                  <strong>Pan: 5° / Tilt: 15°</strong>
                ...
                <div className="ld-eq-row">
                  <span>FPS Current</span>
                  <strong className="ld-text-green">59.1</strong>
                </div>
              </div>
            </div>
            <div className="ld-eq-card">
              ...
              <div className="ld-eq-body">
                ...
                <div className="ld-eq-row">
                  ...
                  <strong>CV Feed + Overlay</strong>
                </div>
                <div className="ld-eq-row">
                  <span>Uptime</span>
                  <strong className="ld-text-green">47h 22m</strong>
                </div>
              </div>
            </div>
            <div className="ld-eq-card">
              ...
              <div className="ld-eq-body">
                <div className="ld-eq-row">
                  <span>IP Address</span>
                  <strong>192.168.1.151</strong>
                </div>
                <div className="ld-eq-row">
                  <span>Connected Devices</span>
                  <strong className="ld-text-green">2 / 2</strong>
                </div>
                <div className="ld-eq-row">
                  <span>Battery</span>
                  <strong>78% / 91%</strong>
...
export default LaneDetailsView;
