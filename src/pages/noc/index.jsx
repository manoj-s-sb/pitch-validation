...
import { Activity, Search, Network, Server, Wifi, Monitor, Tv, Zap, Tablet, Camera } from 'lucide-react';
...
export default function NocPage() {
  ...
  const facility = facilities.find(f => f.id === activeTab);
    ...
    <div className="noc-page">
      ...
      <div className="noc-topbar">
        <div className="noc-topbar-left">
          <Activity size={20} className="noc-topbar-icon" />
        ...
        {facilities.map(f => {
          ...
          return (
            ...
            >
              ...
              <span className="noc-tab-count">{f.lanes.length} lanes</span>
              {s.offline  > 0 && <span className="noc-tab-badge noc-tab-badge-red">{s.offline}</span>}
              {s.warnings > 0 && <span className="noc-tab-badge noc-tab-badge-yellow">{s.warnings}</span>}
            </button>
          );
        })}
      </div>
        ...
        <div className="noc-facility-content">
          ...
          <div className="noc-stats-bar">
            ...
            <div className="noc-stat-cell">
              ...
              <div className="noc-stat-sub">{stats.batting} batting · {stats.hybrid} hybrid</div>
            </div>
          </div>
                  ...
                  return (
                    <>
                      <tr className="noc-group-header">
                        <td colSpan={7}>
                          Infrastructure &amp; Servers — {facility.infrastructure.length} Devices
                        </td>
                      </tr>
                      {rows.map((device, i) => (
